...
public interface BusinessElementRepository extends JpaRepository<BusinessElement, Long> {
    ...
    String SEARCH_BY_FILTER ="select distinct be.*\n " +
    ...
    List<BusinessElement> searchByFilters(@Param("departmentId") Long departmentId, @Param("productId") Long productId, @Param("productEnvId") Long productEnvId, @Param("moduleId") Long moduleId, @Param("serviceNature") String serviceNature);
