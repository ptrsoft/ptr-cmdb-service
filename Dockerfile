...
ENTRYPOINT ["java","-jar","-Djdk.io.File.enableADS=true","-Dserver.profile=dev","-Ddb.server.host=postgresql.ch8wfucynpvq.us-east-1.rds.amazonaws.com","-Ddb.server.port=5431","-Ddb.schema=cmdb","-Ddb.user=postgres","-Ddb.password=Synect!ks2023","/app/core-service-impl-0.0.1-SNAPSHOT.jar"]
